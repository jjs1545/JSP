...
<div id="header">
	...
	<div id="content" align="center">
		...
		<h2>회원 상세정보 수정</h2>
		<hr width="80%">
		<form action="userUpdate.do" name="userUpdate" method="post" onSubmit="return doAction()">
			<table border="1">
			<tr>
				<th>회원 아이디:</th> 
			...
			<input type="button" value="뒤로가기" onclick="location.href='/boardProject/userList.do?id=${ member.id }'"/>
			</center>
		</form>
	</div>
</body>
